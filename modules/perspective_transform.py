...
from sports_callibration.util.projective_camera import ProjectiveCamera
from sports_callibration.models.models import create_model
...
class Perspective_Transform():
    def __init__(self):
        self.query_index = 0
        self.current_directory = os.path.join(os.getcwd(), 'models') 
